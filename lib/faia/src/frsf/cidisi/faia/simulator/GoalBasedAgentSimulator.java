...
public abstract class GoalBasedAgentSimulator extends Simulator {
  ...
  public void start() {
    ...
    /*
     * Simulation starts. The environment sends perceptions to the agent, and it
     * returns actions. The loop condition evaluation is placed at the end. This
     * works even when the agent starts with a goal state (see agentSucceeded method
     * in the SearchBasedAgentSimulator).
     */
    do {
  ...
  /**
   * Here we update the state of the agent and the real state of the simulator.
   * 
   * @param action
   */
  ...
  /**
   * This method is executed in the mail loop of the simulation when the agent
   * returns an action.
   * 
   * @param agent
   * @param action
